 ...
 * 歌单详情页
 */
public class SongMenuRecommendDetailFragment extends BaseFragment implements View.OnClickListener {
    /**
     * 榜单详情页的bean
     * @return
     */
    private SongMenuRecommendDetailFragment mSongMenuDetailFragment;
    /**
     * 榜单详情页适配器
     * @return
     */
    ...
    public static SongMenuRecommendDetailFragment newInstance(String songIdList) {
        Bundle args = new Bundle();
        args.putString("listId",songIdList);
        Log.d("12345", songIdList);
        SongMenuRecommendDetailFragment fragment = new SongMenuRecommendDetailFragment();
    ...
    protected int setLayout() {
        return R.layout.song_menu_recommend_detail_fragment_layout;
    }
    ...
    private void addView() {
        ...
        mImageViewS = (ImageView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_pic_three);
        mStringBuffer = new StringBuffer(Tools.SONG_MUSIC_LIST_DETAIL_URL);
        mImageViewBack = (ImageView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_back_iv);
        mTextViewTitle = (TextView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_title);
        mTextViewTag = (TextView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_tag_tv);
        mImageViewBig = (ImageView)getView().findViewById(R.id.big_tu_song_menu);
        mCountTv = (TextView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_song_count);
        mTextView = (TextView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_desc);
        mRecyclerView = (RecyclerView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_rv);
        mRecyclerView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN|View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mImageViewStarOff = (ImageView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_star_off);
        mImageViewStarOn = (ImageView)getView().findViewById(R.id.fragment_song_menu_recommend_detail_star_on);
        addListener();
    ...
    protected void initData() {
        ...
        songId = bundle.getString("listId");
        Log.d("7777", songId);
        if (songId.isEmpty()){
     ...
     parseData(mNewUrl);
        ...
        mSMDAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void method(int position, SongMenuDetailBean songMenuDetailBean) {
                ...
                Log.d("发GV很快就阿富汗", "DBPlayTools.getInstance().queryAll().size():" + DBPlayTools.getInstance().queryAll().size());
    ...
    private void parseData(String newUrl) {
        NetHelper.MyRequest(newUrl, SongMenuDetailBean.class, new NetListener<SongMenuDetailBean>() {
            ...
            public void successListener(SongMenuDetailBean response) {
                ...
                Log.d("dsfgaf", "response:" + response);
                ...
                Log.d("SongMenuRecommendDetail", mSongMenuDetailBean.getTitle());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.fragment_song_menu_recommend_detail_back_iv:
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentManager.popBackStack();
                fragmentTransaction.setCustomAnimations(R.anim.in,R.anim.out);
                fragmentTransaction.remove(fragmentManager.findFragmentByTag("efg"));

                fragmentTransaction.commit();
                Toast.makeText(context, "点击了", Toast.LENGTH_SHORT).show();
                break;
            case R.id.fragment_song_menu_recommend_detail_star_off:
                Toast.makeText(context, "点击了", Toast.LENGTH_SHORT).show();
                mImageViewStarOn.setVisibility(View.VISIBLE);
                mImageViewStarOff.setVisibility(View.GONE);

                break;
            case R.id.fragment_song_menu_recommend_detail_star_on:
                Toast.makeText(context, "点击了", Toast.LENGTH_SHORT).show();
                mImageViewStarOn.setVisibility(View.GONE);
